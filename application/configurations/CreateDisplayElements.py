...
class CreateDisplay:
    ...
    def build_font(self, text_h):
        if os.name == 'nt':
            ...
            return ImageFont.truetype('%s/pi-watch/application/resources/Oswald.ttf' % (os.getcwd()), text_h)
    ...
    def resize_icons(self, icon_id, text_h):
        if os.name == 'nt':
            ...
            return Image.open('%s/pi-watch/application/resources/icons/%s.png' % (os.getcwd(), icon_id)).convert('RGBA')\
